...
@section('content')
    <section id="create-schedule" class="container card">
        <form action="/dashboard/schedule/{{ $schedule->id }}" method="POST" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group row py-3">
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                        name="name" placeholder="Ex. Agust D day" value="{{ old('name', $schedule->name) }}" required>
                    @error('name')
                ...
                <div class="col">
                    <div class="mb-3">
                        ...
                        <input type="date" class="date form-control @error('date_start') is-invalid @enderror"
                            id="date_start" name="date_start" value="{{ old('date_start', $schedule->date_start) }}"
                            required>
                        @error('date_start')
                            <div class="invalid-feedback">
                                {{ message }}
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="date form-control @error('date_end') is-invalid @enderror"
                            id="date_end" name="date_end" value="{{ old('date_end', $schedule->date_end) }}" required>
                        @error('date_end')
                            <div class="invalid-feedback">
                                {{ message }}
                            </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control @error('place') is-invalid @enderror" id="place"
                        name="place" placeholder="Ex. ICE BSD, Tanggerang" value="{{ old('place', $schedule->place) }}"
                        required>
                    @error('place')
                        <div class="invalid-feedback">
                            {{ message }}
